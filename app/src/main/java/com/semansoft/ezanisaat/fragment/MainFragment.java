package com.semansoft.ezanisaat.fragment;
...
import com.semansoft.ezanisaat.C;
...
public class MainFragment extends MyFragment {
    ...
    private Town town;
    public static final String ACTION_ACTIVE_LOCATION_CHANGED="com.semansoft.ezanisaat.ACTION_LOCATION_CHANGED";
    ...
    public void onStart() {
        ...
        try {
            ...
            textTown.setTextColor(ContextCompat.getColor(getActivity(),town.isActive()?R.color.colorAccent:R.color.white));
        }catch (Exception e){
        }
    }
